...
use Snowdog\Menu\Model\NodeType\CategoryPriceFiltered as ModelCategory;

class CategoryPriceFiltered extends AbstractNode
{
    /**
     * @var string
     */
    protected $defaultTemplate = 'menu/node_type/category_price_filtered.phtml';

    /**
     * @var string
     */
    protected $nodeType = 'category_price_filtered';
    /**
     * @var array
     */
    protected $nodes;
...
HTML;
    ...
    {
        return __("Category Price Filtered");
    }
}
